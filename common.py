...
class ExtrapolationExperiment(Experiment):
    ...
    def __init__(self, estimators, estimator_names, x, y, groups, score=['accuracy', sample_size], verbose=True, extrapolation_index=None, min_test_size=None):
        Experiment.__init__(self, estimators, estimator_names, GroupKFold(len(set(groups))), x, y, groups, score, verbose, extrapolation_index, min_test_size)
